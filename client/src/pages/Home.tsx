...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-[#fcf9f7] pb-20">
      <header className="flex items-center pt-4 pb-2 px-4 w-full bg-[#fcf9f7] relative">
        ...
        <Link href="/add-product">
          <Button variant="ghost" size="icon" className="h-12 w-12 p-0 absolute right-4" data-testid="button-add-product">
